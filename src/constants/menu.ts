...
export const getAdminMenu = () => [
  ...
  {
    categoryCode: t`ASSIGNMENT`,
    code: "assignment",
    icon: "assignment",
    title: t`Assignments`,
    header: t`Assignment Management`,
    url: "/manage/assignment",
  },
  {
    categoryCode: t`SCORE`,
    code: "score",
    icon: "score",
    title: t`Scores`,
...
export const getStudentMenu = () => [
  ...
  },
  {
    ...
    url: "/manage/student/assignments",
  },
  {
    categoryCode: t`LEARNING`,
    code: "scores",
