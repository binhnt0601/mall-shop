...
import image from '@/assets/about-us-2-2.png';
...
export default function Frame2_2() {
    ...
    const bodyText = (
        <span>
            ...
            transforming industries worldwide. Under our bold slogan
            &apos;blocks the world&apos;, we strive to unlock the full potential
            of blockchain technology, making every transaction more transparent,
