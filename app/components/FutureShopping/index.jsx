            ...
            <div className="w-full flex lg:flex-row flex-col gap-5 py-10 md:px-14 text-white bg-[#270f0b]">
                <div className="lg:w-[50%] w-full p-6">
                    ...
                    <Typography className="text-justify">
                        AiMalls is an AI-powered online mall that offers a
                        personalized, secure and hassle-free shopping
                        experience. With intelligent algorithms, you get faster
                        and more accurate search results and product
                        recommendations, plus pricing strategy and 24/7 customer
