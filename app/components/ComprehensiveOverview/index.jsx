...
export default function ComprehensiveOverview() {
  ...
  return (
    <div className="mt-32 flex w-full flex-col items-center gap-5 py-10">
      <div className="mb-5">{headline}</div>
      <div className="mb-40 max-w-full px-5 md:max-w-[565px] md:px-0">
        <Section1 />
      </div>
      <Section2 />
    </div>
...
const Section1 = () => {
  return (
    <div>
      ...
      <Typography>
        EngLish Classuse advanced Al technology to analyze sales and inventory
      ...
      <Typography>
        Furthermore, EngLish Classare available 24/7, meaning customers can shop
        ...
        they need them. All in all, EngLish Classoffer a range of advantages
...
const missionData = [
  {
    ...
    title: 'Our Goal',
    description:
      'EngLish Classshort-term goal is to attract sellers and buyers to the platforms and establish a reputation for providing a high-quality shopping experience. EngLish Classlong-term goal is to become one of the leading online marketplaces worldwide.',
  },
...
const Section2 = () => {
  return (
    <div className="mx-5 flex flex-col rounded-3xl border-2 border-[#fc9a14] sm:mx-12 md:flex-row lg:mx-32">
