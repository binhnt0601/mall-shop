...
export default function TargetFutureShopping() {
  ...
  return (
    <Stack className="w-full items-center gap-5 bg-[#270f0b] pb-[100px] pt-[50px] lg:px-24">
      ...
      <div className="flex flex-wrap justify-center">
        {data.map((item, index) => (
          <Card
            key={`card-item-${index}`}
            className="m-5 w-full border-2 border-[#fc9a14] bg-gradient-to-b 
                        from-[#2f1d19] to-[#201211] sm:w-2/5 md:w-[28%]"
          >
