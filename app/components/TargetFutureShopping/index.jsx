...
const data = [
    ...
    },
    {
        ...
        description:
            'AiMalls helps you manage your inventory more efficiently with automated stock tracking, order processing, and delivery management. You can also track customer orders in real-time to ensure seamless service.',
    },
    {
    ...
    },
    {
        ...
        description:
            "AiMalls offers personalization features that allow you to build a relationship with your customers, getting in touch when it's most effective and maximizing conversions. Our products and technology provide the infrastructure for success.",
    },
];
...
export default function TargetFutureShopping() {
    const headline = (
        ...
        >
            The <span style={{ color: '#fc9a14' }}>Future of Shopping</span> is
            Here
        </Typography>
    );
        ...
        <Stack className="w-full pt-[50px] pb-[100px] items-center gap-5 bg-[#270f0b]">
            <div className="max-w-[640px] text-center">
                ...
                <Typography color="white">
                    ...
                    to make your shopping easier, faster and more enjoyable.
                </Typography>
            </div>
